...
%R_roi if 0 scan all the image, else 
function [location,reliability] = matching_features_surf(piece,img_grid,num_row,num_col,app,R_roi)
...
points2 = detectSURFFeatures(gray_grid,"MetricThreshold",MetricThreshold,"NumOctaves",NumOctaves,"NumScaleLevels",NumScaleLevels,"ROI",roi);
